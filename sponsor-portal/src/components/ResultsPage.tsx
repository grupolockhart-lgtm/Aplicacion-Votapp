...
return (
  <Container maxWidth="lg" sx={{ mt: 4 }}>
    ...
    <TypedGrid container spacing={3} sx={{ mt: 2 }}>
      <TypedGrid item xs={4}>
        <Card><CardContent><Typography>Participantes</Typography><Typography variant="h4">{results.total_participants}</Typography></CardContent></Card>
      </TypedGrid>
      <TypedGrid item xs={4}>
        <Card><CardContent><Typography>Votos totales</Typography><Typography variant="h4">{results.total_votes}</Typography></CardContent></Card>
      </TypedGrid>
      <TypedGrid item xs={4}>
        <Card><CardContent><Typography>Presupuesto total</Typography><Typography variant="h4">{formatCurrency(results.presupuesto_total)}</Typography></CardContent></Card>
      </TypedGrid>
    </TypedGrid>
